 ...
 * @package Inspekt
 */
define('INSPEKT_DIR',	dirname(__FILE__));

/**
 * Inspekt_Error
 */
require_once(INSPEKT_DIR.'/Inspekt/Error.php');

/**
 * Inspekt_Cage
 */
require_once(INSPEKT_DIR.'/Inspekt/Cage.php');

/**
 * Inspekt_Cage_Session
 */
require_once(INSPEKT_DIR.'/Inspekt/Cage/Session.php');

/**
 * Inspekt_Supercage
 */
require_once(INSPEKT_DIR.'/Inspekt/Supercage.php');
