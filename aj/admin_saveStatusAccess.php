...
if($access=="false") {
	...
	$query = sprintf("DELETE FROM emp_status_access WHERE acctID = %d && statusID = %d LIMIT 1",$uid,$sid);
} else {
	$action = "ACCESS GRANTED";
	$query = sprintf("INSERT INTO emp_status_access (acctID,statusID) values(%d,%d)",$uid,$sid);
}
